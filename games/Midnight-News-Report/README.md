...
- **适用版本：** Steam Windows 版（2026-09-17 制作时版本）
- **Steam AppID：** `4894100`
...
- **文件大小：** 41,671,749 字节
- **SHA-256：** `7F4AF2277ABDA55ADCB5FA030878BE134D39512BB5872BCBE0C27A7DCD3DFAEB`
- **压缩包文件数量：** 13
- **发布状态：** 已发布
...
- 发布附件大小与本地成品一致，GitHub Release 附件摘要与本页 SHA-256 一致。
