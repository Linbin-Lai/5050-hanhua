...
- **适用版本：** Steam AppID 4406280，适配 2026-08-30 的 Steam 抢先体验版本
...
- **文件大小：** 23,485,979 字节
- **SHA-256：** `55BD2598D506C084BE996270C5E3095894225732B8246FC52624F0834ABA7309`
- **压缩包文件数量：** 10
- **发布状态：** 已发布（不完全汉化）
- **下载地址：** [the cabin game 简体中文汉化](https://github.com/Linbin-Lai/5050-hanhua/releases/tag/the-cabin-game-cn-20260830)
...
- 面向 Steam AppID 4406280 的 2026-08-30 抢先体验版本制作。
- 可直接安装到未安装汉化工具的原版游戏。
...
- 覆盖包可正常读取，共 10 个文件，第一层为 `the_cabin_game/` 与 `安装说明.txt`。
- 覆盖包 SHA-256 为 `55BD2598D506C084BE996270C5E3095894225732B8246FC52624F0834ABA7309`。
